            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                    <div className="hidden md:block">
                        <h3 className="text-sm font-bold text-slate-900">Compare Products</h3>
                    ...
                    {compareList.map((product, index) => (
                        <div key={product.id || product.productId || index} className="relative group">
                            <div className="w-12 h-12 rounded-lg border border-slate-200 p-1 bg-white">
                                <img
                                    src={product.image}
                                    alt={product.title}
                ...
                <div className="flex items-center space-x-4">
                    <button
                        ...
                        className="text-sm text-slate-500 hover:text-red-600 font-medium underline"
                    >
                        Clear All
                    </button>
                    <Link
