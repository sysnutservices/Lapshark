    ...
    return (
        <>
            ...
            <div className="bg-gray-50 min-h-screen py-6 md:py-12 pb-40 md:pb-12">
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex-1 flex flex-col justify-between min-w-0">
                                                ...
                                                <div className="flex items-end justify-between mt-3">
                                                    ...
                                                    <div className="flex items-center border border-gray-200 rounded-lg shadow-sm h-7">
                                                        <button
                                                        ...
                                                        <span className="w-6 text-center font-bold text-gray-900 text-sm bg-white h-full flex items-center justify-center border-gray-200">
                                                            {item.quantity}
                                                        </span>
                                                        <button
                                                            onClick={() => updateQuantity(item.id?.toString() || '', 1)}
                                        ...
                                        <div key={item.id} className="p-4 md:p-6">
                                            <div className="grid grid-cols-12 gap-6 items-center">
                                                <div className="col-span-6 w-full flex items-center gap-6">
                                                    <div className="w-24 h-24 flex-shrink-0 bg-gray-50 rounded-lg p-2 border border-gray-100">
                                                        <img
                                                            src={API_URL2 + item.image}
                                                            alt={item.title}
                                                            className="w-full h-full object-contain mix-blend-multiply"
                                                ...
                                                <div className="col-span-2 text-center md:text-right font-bold text-gray-900">
                                                    ₹
                ...
                <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 shadow-[0_-4px_20px_-1px_rgba(0,0,0,0.1)] md:hidden z-30 flex items-center justify-between gap-4 pb-6">
