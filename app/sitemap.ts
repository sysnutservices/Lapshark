...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticRoutes: MetadataRoute.Sitemap = [
        ...
        { url: `${SITE_URL}/refurbished-laptops-bangalore`, changeFrequency: "weekly", priority: 0.9 },
        { url: `${SITE_URL}/store/bangalore`, changeFrequency: "monthly", priority: 0.8 },
        ...
        { url: `${SITE_URL}/refurbished-dell-laptops-bangalore`, changeFrequency: "weekly", priority: 0.7 },
        { url: `${SITE_URL}/refurbished-hp-laptops-bangalore`, changeFrequency: "weekly", priority: 0.7 },
        { url: `${SITE_URL}/refurbished-lenovo-laptops-bangalore`, changeFrequency: "weekly", priority: 0.7 },
        { url: `${SITE_URL}/refurbished-apple-macbooks-bangalore`, changeFrequency: "weekly", priority: 0.7 },
