            ...
            {loading ? (
                ...
                <>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
                        <StatCard title="Visitors" value={stats.visitors} icon={Users} color="text-blue-500" bgColor="bg-blue-100" />
                        ...
                        <StatCard title="Purchases" value={stats.purchases} icon={TrendingUp} color="text-green-500" bgColor="bg-green-100" />
